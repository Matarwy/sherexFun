...
const LAUCHPAD_TX_MSG = {
  launchBuy: {
    title: 'birthpad.launch_and_buy',
    desc: 'birthpad.buy_token_desc',
    txHistoryTitle: 'birthpad.launch_and_buy',
    txHistoryDesc: 'birthpad.buy_token_desc',
    components: { sub: <Text as="span" color={colors.textSecondary} fontWeight="700" /> }
  },
  buy: {
    title: 'birthpad.buy_token_title',
    desc: 'birthpad.buy_token_desc',
    txHistoryTitle: 'birthpad.buy_token_title',
    txHistoryDesc: 'birthpad.buy_token_desc',
    components: { sub: <Text as="span" color={colors.textSecondary} fontWeight="700" /> }
  },
  sell: {
    title: 'birthpad.sell_token_title',
    desc: 'birthpad.sell_token_desc',
    txHistoryTitle: 'birthpad.sell_token_title',
    txHistoryDesc: 'birthpad.sell_token_desc',
    components: { sub: <Text as="span" color={colors.textSecondary} fontWeight="700" /> }
  }
}
