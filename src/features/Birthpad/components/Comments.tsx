...
import { Comment } from '@/hooks/birthpad/type'
import usePoolComments from '@/hooks/birthpad/usePoolComments'
import dayjs from 'dayjs'
import Dev from '@/icons/misc/Dev'
import { useWalletColor } from '@/hooks/birthpad/useWalletColor'
        ...
        <Flex alignItems="center" gap={1}>
          ...
          <Flex alignItems="center" gap={1} fontSize="sm" pr="0.5rem">
            <Link
              ...
              href={`/birthpad/profile/?wallet=${comment.wallet}${referrerQuery}`}
            >
