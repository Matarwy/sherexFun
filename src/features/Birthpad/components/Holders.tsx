...
import useHolders from '@/hooks/birthpad/useHolders'
          ...
          >
            ...
            <Flex gap={1} alignItems="center">
              ...
              {item.address === poolVault && (
                <Tooltip hasArrow placement="top" label={t('birthpad.raydium_pool')}>
                  <Box>
              ...
              {item.address === mintVault && (
                <Tooltip hasArrow placement="top" label={t('birthpad.bongding_curve')}>
                  <Box>
                    <Government />
                  </Box>
                </Tooltip>
