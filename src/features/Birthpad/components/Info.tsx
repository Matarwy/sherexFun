      ...
      >
        ...
        <Flex direction="column" color={colors.textSecondary} fontSize="sm" gap={1}>
          <Flex justifyContent="space-between" alignItems="center">
            ...
            >
              <Text color={colors.textBirthpadLink} decoration="underline">
                {encodeStr(mintInfo.mint, 5, 3)}
              </Text>
              <Box>
                {hasCopied ? (
                  <CircleCheck width="14px" height="14px" color={colors.textBirthpadLink} />
                ) : (
                  <CopyBirthpadIcon width="14px" height="14px" color={colors.textBirthpadLink} />
                )}
              </Box>
            </Flex>
          </Flex>
