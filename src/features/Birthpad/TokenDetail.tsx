...
import { Info as InfoIcon, X } from 'react-feather'
        ...
        {isMobile ? (
          <Flex direction="column" gap={1}>
            ...
            <Flex
              ...
              py={2}
            >
              <Text fontSize="sm" color={colors.textBirthpadLink} lineHeight="15px">
          ...
          >
            <Flex alignItems="center" gap={1}>
              ...
              <Text ml={4} fontSize="sm" color={colors.textBirthpadLink}>
                Market cap: {mintInfo ? formatCurrency(mintInfo.marketCap, { symbol: '$', abbreviated: true, decimalPlaces: 2 }) : '--'}
              </Text>
            </Flex>
