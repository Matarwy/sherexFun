import {
  Box, Button, Collapse, Flex, FormControl, FormLabel, Grid, Skeleton, Switch, Text, useBreakpointValue, useColorMode, useOutsideClick
...
import { MintSortField } from '@/hooks/birthpad/useMintList'
import useTopMintList from '@/hooks/birthpad/useTopMintList'
...
import { OnSearchChangeData, SearchInput } from './components/SearchInput'
...
export default function Birthpad() {
          ...
          <>
            ...
            <Flex direction="column" gap={3}>
              <Flex justifyContent="space-between" alignItems="center">
                ...
                <Link href={`/birthpad/create${referrerQuery}`} shallow>
                  <Button
                    width="8.75rem"
                    height="2.125rem"
                    minHeight="2.125rem"
        ...
        <Flex justifyContent={['space-between', 'flex-start']} gap={16} pt={3}>
          <Flex alignItems="center">
            <FormControl display="flex" alignItems="center">
              <FormLabel color={colors.lightPurple}>{t('birthpad.show_animations')}</FormLabel>
              <Switch defaultChecked={showAnimations} onChange={handleSwitchAnimationsChange} />
            </FormControl>
          </Flex>
          <Flex alignItems="center">
            <FormControl display="flex" alignItems="center">
              <FormLabel color={colors.lightPurple}>{t('birthpad.include_nsfw')}</FormLabel>
