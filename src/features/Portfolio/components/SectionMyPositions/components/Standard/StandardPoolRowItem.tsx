import { Box, Button, Collapse, Flex, GridItem, HStack, Skeleton, Text, useDisclosure, VStack } from '@chakra-ui/react'
...
import { FarmBalanceInfo, FormattedFarmInfoV6 } from '@/hooks/farm/type'
...
export default function StandardPoolRowItem({ pool, isLoading, position, stakedFarmMap, allFarmBalances, lockInfo }: PoolItemProps) {
  ...
  const lockInfoRef = useRef<CpmmLockData | undefined>(undefined)
